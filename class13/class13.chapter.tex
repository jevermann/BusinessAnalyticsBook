...
\url{https://www.youtube.com/watch?v=UWuADwhZWI0}
\end{videobox}
\end{advanced}
...
\begin{itemize}
  ...
  \item The analyst retains principal components as long as their eigenvalues are above the corresponding eigenvalues of random data (''parallel analysis'')
...
\begin{exerciseboxpaper}
Use agglomerative hierarchical clustering on the following three-dimensional dataset. Include the dendrogram. Show all work.
