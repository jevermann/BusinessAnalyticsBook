...
\url{https://www.youtube.com/watch?v=XwlbqnhRICs}
\end{videobox}
\end{advanced}
...
\begin{exerciseboxpaper}
The following steps of the CI/CD pipeline are out of order. Number them from \textbf{1 (first)} to \textbf{8 (last)}.
...
\begin{exerciseboxpaper}
A city government plans to deploy an AI system to prioritize road maintenance projects. For each of the following statements answer: ''YES'', ''NO'', or ''NEED MORE INFORMATION''
