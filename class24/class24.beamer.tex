...
\begin{frame}[label=full]{Intentional Torts}
...
\begin{frame}[label=full]{Negligence}
...
\begin{frame}[label=full]{Contracts} 
...
\begin{frame}[label=full]{Licences}
...
\begin{frame}[label=full]{Copyrights}
...
\begin{frame}[label=full]{Websites}
...
\begin{frame}[label=full,fragile]{Example Robots File}
\begin{textcode}
...
\begin{frame}[label=full]{Privacy Legislation}
  \begin{itemize}
...
\hline
1 & Accountability & A & Allow individuals to see their information \\
\hline
2 & Identifying Purposes & B & Restrict use, disclosure, and retention \\
\hline
3 & Consent & C & Organization is responsible for compliance \\
\hline
4 & Limiting Collection & D &  Keep information current and correct \\
\hline
5 & Limiting Use & E & Collect only necessary information \\
\hline
6 & Accuracy & F & Explain why information is collected\\
\hline
7 & Safeguards & G & Provide complaint procedures \\
\hline
8 & Openness & H & Be transparent about privacy practices \\
\hline
9 & Individual Access & I & Protect personal information \\
\hline
10 & Challenging Compliance & J &  Obtain permission before collection or use \\ \hline
\end{tabular}
\end{frame}
...
\begin{frame}[label=full]{PIPEDA -- 1. Accountability}
...
\begin{frame}[label=full]{PIPEDA -- 1. Accountability \small (Building Blocks)}
   \begin{itemize}
...
\begin{frame}[label=full]{PIPEDA -- 1. Accountability \small (Ongoing Assessment and Revision)}
\begin{itemize}
...
\begin{frame}[label=full]{PIPEDA -- Cross-Border Personal Data Processing}
\begin{itemize}
...
\begin{frame}[label=full]{PIPEDA -- 2. Identifying Purpose}
\begin{itemize}
...
\begin{frame}[label=full]{PIPEDA -- 3. Consent}
\begin{itemize}
...
\begin{frame}[label=full]{PIPEDA -- 3. Consent \small (Guidelines)}
\begin{itemize}
...
\begin{frame}[label=full]{PIPEDA -- 3. Consent \small (Interpretation)}
\begin{itemize}
...
\begin{frame}[label=full]{PIPEDA -- 3. Consent \small (Example Decisions)}
\begin{itemize}
...
\begin{frame}[label=full]{PIPEDA -- 3. Consent \small (Implied Consent)}
\begin{itemize}
...
\begin{frame}[label=full]{PIPEDA -- 3. Consent \small (Conditions for Opt-out Consent)}
\begin{itemize}
...
\begin{columns}
\begin{column}{0.2\textwidth}
\href{https://commons.wikimedia.org/wiki/File:Paper_and_pencil_Pinhead_icon.svg}{\includegraphics[width=.75\textwidth]{../pencilblack.png}}\end{column}
\begin{column}{0.8\textwidth}
\small
...
\begin{frame}[label=full]{PIPEDA -- 4. Limiting Collection}
\begin{itemize}
...
\begin{frame}[label=full]{PIPEDA -- Video Data Collection}
\begin{itemize}
...
\begin{frame}[label=full]{PIPEDA -- 5. Limiting Use, Disclosure, and Retention}
\begin{itemize}
...
\begin{frame}[label=full]{Guidelines for Media Sanitization}
\centering
...
\begin{frame}[label=full]{PIPEDA -- 6. Accuracy}
\begin{itemize}
...
\begin{frame}[label=full]{PIPEDA -- 6. Accuracy \small (Interpretation)}
\begin{itemize}
...
\begin{frame}[label=full]{PIPEDA -- 7. Safeguards}
\begin{itemize}
...
\begin{frame}[label=full]{PIPEDA -- 7. Safeguards \small (Interpretation)}
\begin{itemize}
...
\begin{frame}[label=full]{PIPEDA -- 7. Safeguards \small (''Employee Snooping'')}
\begin{itemize}
...
\begin{frame}[label=full]{PIPEDA -- 8. Openness}
\begin{itemize}
...
\begin{frame}[label=full]{PIPEDA -- 9. Individual Access}
\begin{itemize}
...
\begin{frame}[label=full]{PIPEDA -- 9. Access \small (Exemptions)}
\begin{itemize}
...
\begin{frame}[label=full]{PIPEDA -- 10. Challenging Compliance}
\begin{itemize}
...
\begin{frame}[label=full]{PIPEDA -- Privacy Breach}
\begin{itemize}
...
\begin{frame}[label=full]{Other Data Protection and Privacy Laws}
\begin{itemize}
...
\begin{frame}[label=advanced]{Bill C-27}
...
\begin{frame}[label=advanced]{AIDA}
  \begin{itemize}
...
\begin{frame}[label=advanced]{AIDA -- High Impact Examples}
...
\begin{frame}[label=advanced]{AIDA -- Harms}
\begin{itemize}
...
\begin{frame}[label=advanced]{AIDA -- Requirements}
...
\begin{frame}[label=advanced]{AIDA -- Examples Measures}
...
\begin{frame}[label=advanced]{European Union AI Act}
