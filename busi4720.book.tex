...
\\ \vspace{\baselineskip} \large Theory and Applications Edition}
\end{withcode}
\begin{nocode}
\title{Business Analytics
\\ \vspace{\baselineskip} \large Theory and Concepts Edition}
\end{nocode}
\begin{simplified}
\title{Business Analytics
\\ \vspace{\baselineskip} \large Simplified Edition}
\end{simplified}
...
\IfStrEq{\IncludeCode}{Simplified}{}
{  
...
\input{class18/class18.chapter.tex}
}
...
\graphicspath{{math/}}
\chapter{Some Useful Mathematical Concepts}
\input{math/math.chapter.tex}

\begin{withcode}
\graphicspath{{software/}}
\chapter{Installing Required Software}
\input{software/software.chapter.tex}

\graphicspath{{commandline/}}
\chapter{The Linux/Unix Command Line}
\input{commandline/commandline.chapter.tex}
