...
\begin{frame}[label=withcode,fragile]{Data Preparation}
...
%\begin{frame}[label=withcode,fragile]{Histogram with Summary Information}
...
%\begin{frame}[label=withcode,fragile]{Histogram with Summary Information \small [cont'd]}
%\footnotesize
%\begin{pythoncode}
...
%\begin{frame}[label=full]{Histogram with Summary Information}
...
\begin{frame}[label=withcode,fragile]{Pie/Donut Chart}
\begin{columns}
...
%\begin{frame}[label=withcode,fragile]{Donut Chart}
%\footnotesize
%\begin{pythoncode}
...
%\begin{frame}[label=full]{Pie Chart}
%\centering
...
\begin{frame}[label=withcode,fragile]{2D Histogram Plot}
\footnotesize
\begin{pythoncode}
...
\begin{frame}[label=withcode,fragile]{Density Heatmap with Marginals}
\scriptsize
\begin{pythoncode}
...
\begin{frame}[label=full]{Dashboards}
\begin{columns}
\begin{column}{.35\textwidth}
\footnotesize
\begin{itemize}
...
\begin{frame}[label=withcode,fragile]{Step 1 -- Import Packages}
...
\begin{frame}[label=withcode,fragile]{Step 2 -- Visual Layout}
\begin{itemize}
...
\begin{frame}[label=withcode,fragile]{Step 2 -- Visual Layout \small [cont'd]}
\begin{pythoncode}
...
\begin{frame}[label=full]{Dashboard Visual Layout \small [cont'd]}
\begin{center}
...
\begin{frame}[label=withcode,fragile]{Step 3 -- Create the Figures}
\begin{pythoncode}
@callback(
...
\begin{frame}[label=withcode,fragile]{Step 4 -- Run the App}
