...
\begin{frame}[label=withcode,fragile]{Requirements}

Examples in this module require additional Python packages; install from the bash command line:
...
\begin{frame}[label=full]{Data Augmentation}
...
\begin{frame}[label=full]{Data Augmentation \small [cont'd]}
...
\begin{frame}[label=full]{Hands-On Exercise --- SMOTE}
\begin{columns}
...
\textbf{ID} & \textbf{Income} & \textbf{Assets} & \textbf{Debt} & \textbf{VIP} \\
\hline
A & 1.0 & 2.0 & 1.0 & 0 \\
B & 2.0 & 1.0 & 2.0 & 0 \\
C & 2.0 & 3.0 & 1.0 & 0 \\
...
\end{columns}
\begin{enumerate}
   \item Select at random one of the minority observations ($O_1$)
   \item Identify the 3 closest minority class observations to $O_1$ (use Euclidean distances)
   \item Select at random one of the 3 closest minority class observations ($O_2$)
   \item Compute the difference vector between ($O_2 - O_1$)
   \item Select at random an interpolation factor $[0, 1]$
   \item Calculate the new synthetic data point
\end{enumerate}
\end{frame}

\begin{frame}[label=withcode,fragile]{SMOTE in Python}
...
\begin{frame}[label=withcode]{Hands-On Exercise}\begin{columns}
\begin{column}{0.1\textwidth}
...
\begin{frame}[label=full]{Transfer Learning}
...
\begin{frame}[label=full]{Transfer Learning \small [cont'd]}
...
\begin{frame}[label=withcode,fragile]{Data Augmentation in Python}
...
\begin{frame}[label=withcode,fragile]{Data Augmentation in Python \small [cont'd]}
...
\begin{frame}[label=withcode]{Data Augmentation in Python \small [cont'd]}
Before and after:
...
\begin{frame}[label=withcode,fragile]{Transfer Learning in Python}
...
\begin{frame}[label=withcode,fragile]{Transfer Learning in Python \small [cont'd]}
...
\begin{frame}[label=withcode]{Data Augmentation and Transfer Learning in Python}
...
\begin{frame}[label=full]{Adapters}
...
\begin{frame}[label=full]{Adapters \small [cont'd]}
...
\begin{frame}[label=full]{Attention}
\begin{itemize}
...
\begin{frame}[label=full]{Attention \small [cont'd]}
...
\begin{frame}[label=full]{Attention in Seq2Seq Models}
...
\begin{frame}[label=full]{Multi-Headed Attention}
\begin{align*}
...
\begin{frame}[label=full]{Self-Attention}
...
\begin{frame}[label=full]{Positional Encoding}
...
\begin{frame}[label=full]{Positional Encoding \small [cont'd]}
\begin{itemize}
...
\begin{frame}[label=withcode,fragile]{Positional Encoding in Python}
Define weights:
\begin{pythoncode}
import numpy as np
...
\begin{frame}[label=withcode,fragile]{Positional Encoding in Python \small [cont'd]}
Define Keras layer:
\begin{pythoncode}
...
\begin{frame}[label=full,fragile]{Transformer}
...
\begin{frame}[label=full]{Transformer \small [cont'd]}
\centering
...
\begin{frame}[label=withcode,fragile]{Transformer Encoder in Python}
...
\begin{frame}[label=full]{ELMo --''Embeddings from Language Model''}
...
\begin{frame}[label=full]{Comparison of BERT and GPT Architectures}
\centering
...
\begin{frame}[label=full]{BERT -- Pre-Training Tasks \small [cont'd]}
\begin{itemize}
...
\begin{frame}[label=full]{BERT -- Example Fine-Tuning Tasks}
\begin{itemize}
...
\begin{frame}[label=withcode]{Tensorflow and Keras Tutorials}
...
\begin{frame}[label=full]{Auto-Encoder}
...
\begin{frame}[label=withcode]{Auto-Encoder in Python}
...
\begin{frame}[label=withcode,fragile]{Auto-Encoder in Python \small [cont']}
Encoder:
\begin{pythoncode}
...
\begin{frame}[label=withcode,fragile]{CNN Auto-Encoder in Python \small [cont']}
...
\begin{frame}[label=withcode]{Auto-Encoder Examples}
...
\begin{frame}[label=full]{Auto-Encoder Examples}
...
\begin{frame}[label=full]{Auto-Encoder -- Denoising}
\begin{itemize}
...
\begin{frame}[label=full]{VAE -- Variational Auto-Encoder}
...
\begin{frame}[label=withcode]{VAE in Python}
...
\begin{frame}[label=withcode,fragile]{VAE in Python \small [cont']}
...
\begin{frame}[label=withcode,fragile]{VAE in Python \small [cont'd]}
...
\begin{frame}[label=full]{GAN -- Generative Adversarial Networks}
...
\begin{frame}[label=full]{GAN -- Generative Adversarial Networks \small [cont'd]}
...
%\begin{frame}[label=full,fragile]{GAN in Python}
...
\begin{frame}[label=withcode]{GAN in Python}
...
\begin{frame}[label=withcode,fragile]{GAN in Python}
...
\begin{frame}[label=withcode,fragile]{GAN in Python \small [cont'd]}
...
\begin{frame}[label=full]{GAN Training}
