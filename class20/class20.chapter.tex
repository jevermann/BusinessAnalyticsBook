...
\url{https://www.youtube.com/watch?v=TA4Y7E1E1k0&pp=0gcJCZkLAYcqIYzv}
\end{videobox}
\end{advanced}
...
A company's sales data are stored distributed in each branch. They use Map-Reduce to find totals by product category.
...
Define Map and Reduce phases to calculate how much total revenue each product category generated across all stores. 
...
\begin{enumerate}
   ...
   \item What does the Reduce phase do? What are the keys and values of its output?
\end{enumerate}
