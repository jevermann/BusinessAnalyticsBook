...
\url{https://www.youtube.com/watch?v=wPlpNBPYnH0&pp=0gcJCZkLAYcqIYzv}
\end{videobox}
\end{advanced}
...
\begin{enumerate}
  ...
  \item Calculate $h_t$
\end{enumerate}
\begin{align*}\text{{\bf Recall}: }\quad\sigma(a)=\frac{1}{1+e^{-a}}\end{align*}
...
\section{Example -- Next Activity Prediction in Business Processes}
