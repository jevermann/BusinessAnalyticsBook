...
\begin{frame}[label=full]{Introduction}
...
\begin{frame}[label=full]{Types of Analytics}
...
\begin{frame}[label=full]{Data and Models}
\begin{block}{Data}
\begin{itemize}
...
\begin{frame}[label=full]{Learning}
...
\begin{frame}[label=full]{Analytics is not Statistics}
\footnotesize
\begin{itemize}
...
\begin{frame}[label=full]{This Course}
...
\begin{frame}[label=withcode]{Tools}
...
\begin{frame}[label=withcode]{Python}
...
%\begin{frame}[label=full]{Virtual Machine Environment}
...
\begin{frame}[label=withcode]{Database Management Systems}
\begin{columns}
\begin{column}{.25\textwidth}
\centering 
...
\begin{frame}[label=withcode]{Software Versions and Sources}
...
\begin{frame}[label=withcode]{R Libraries and Versions}
...
\begin{frame}[label=withcode]{Python Packages and Versions}
...
\begin{frame}[label=withcode]{Related Tools}
...
\begin{frame}[label=withcode]{In-Class Activity}

Download and install the required software on your computer. 
	\begin{itemize}
