...
\url{https://www.youtube.com/watch?v=lrsr22rFmdo}
\end{videobox}
\end{advanced}
...
While there does not exist a standardized serialization format for property graph data interchange, PG-JSON and GraphSON are two recent proposals to describe property graphs in a JSON object. 
\begin{advanced}
These are shown in Figure~\ref{fig:pgjson} and Figure~\ref{fig:graphson}.
...
\begin{exerciseboxcomputer}
\subsubsection*{Character Formats}
\begin{enumerate}
