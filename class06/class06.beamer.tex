...
\begin{frame}[label=full]{Intro to Python}
...
\begin{frame}[label=full]{Running Python}
\begin{enumerate}
...
\begin{frame}[label=full]{Interactive Python Shell}
\begin{itemize}
...
\begin{frame}[label=full]{Jupyter Notebooks}
\begin{itemize}
...
\begin{frame}[label=full]{JupyterLabs Desktop}
...
\begin{frame}[label=full]{PyCharm IDE}
\begin{itemize}
...
\begin{frame}[label=full,fragile]{Basic Python}
Python knows math:
\footnotesize
\begin{pythoncode}
# Addition
...
\begin{frame}[label=full,fragile]{Python Strings}
...
\begin{frame}[label=full,fragile]{Lists}
...
\begin{frame}[label=full,fragile]{Tuples}
...
\begin{frame}[label=full,fragile]{Dictionaries}
\begin{itemize}
...
\begin{frame}[label=full,fragile]{Dictionaries \small [cont'd]}
\begin{pythoncode}
...
\begin{frame}[label=full]{Structured Data Types}
...
\begin{frame}[label=full,fragile]{Slicing}
\footnotesize
\begin{pythoncode}
...
\begin{frame}[label=full]{Numerical Data in Python with NumPy}
...
\begin{frame}[label=full,fragile]{NumPy Array}
...
\begin{frame}[label=full,fragile]{NumPy Basics}
...
\begin{frame}[label=full,fragile]{NumPy Basics \small [cont'd]}
...
\begin{frame}[label=full,fragile]{Array Slicing}
\begin{itemize}
...
%\begin{frame}[label=full,fragile]{Array Slicing \& Iterators}
%\footnotesize
%\begin{pythoncode}
%c = np.array([[[  0,  1,  2],
               %[ 10, 12, 13]],
...
\begin{frame}[label=full,fragile]{Array Reshaping}
...
\begin{frame}[label=full,fragile]{Array Indexing with Boolean Arrays}
...
%\begin{frame}[label=full,fragile]{Unique Elements and Counts}
%\footnotesize
%\begin{pythoncode}
...
\begin{frame}[label=full]{Hands-On Exercises}\begin{columns}
\begin{column}{0.2\textwidth}
\href{https://commons.wikimedia.org/wiki/File:NotoSans_-_Keyboard_And_Mouse_-_1F5A6.svg}{\includegraphics[width=\textwidth]{../computerblack.png}}
\end{column}
\begin{column}{0.8\textwidth}
...
\begin{frame}[label=full]{Data Management with Pandas}
...
%\begin{frame}[label=full,fragile]{Pandas Series}
%\begin{itemize}
...
%\begin{frame}[label=full,fragile]{Pandas Series \small [cont'd]}
%\footnotesize
%\begin{pythoncode}
...
\begin{frame}[label=full,fragile]{Pandas Dataframe}
\begin{itemize}
   \item 2-dimensional
...
\begin{frame}[label=full,fragile]{Pandas Dataframe -- Basic Information}
\footnotesize
\begin{pythoncode}
...
%\begin{frame}[label=full,fragile]{Pandas Dataframe Columns}
%\footnotesize
%\begin{pythoncode}
%# Access a column
%df['col1']
...
%\begin{frame}[label=full,fragile]{Dataframe Indexing}
...
\begin{frame}[label=full,fragile]{Pandas Dataframe -- Indexing}
\begin{pythoncode}
# Select one column
df['col1']
...
\begin{frame}[label=full,fragile]{Pandas Dataframe -- Operations}
%\begin{itemize}
...
%\begin{frame}[label=full,fragile]{Descriptive Statistics, Aggregation, \& Strings}
...
\begin{frame}[label=full,fragile]{Pandas Dataframe -- Selection with Query}
...
%\begin{frame}[label=full,fragile]{Selection with Query \small [cont'd]}
%\footnotesize
%\begin{pythoncode}
...
%\begin{frame}[label=full,fragile]{Duplicate Data}
%\footnotesize
%\begin{pythoncode}
%df2 = df.copy()
...
%\begin{frame}[label=full,fragile]{Reading Data into Pandas}
%\begin{itemize}
...
\begin{frame}[label=full]{Easy Pandas -- Example Dataset}
\begin{itemize}
...
\begin{frame}[label=full,fragile]{Easy Pandas -- Reading CSV Files}
\begin{pythoncode}
# Import pandas 
import pandas as pd
...
\begin{frame}[label=full,fragile]{Easy Pandas -- Filtering}
\begin{pythoncode}
# Filter values
...
\begin{frame}[label=full,fragile]{Easy Pandas -- Selecting Columns}
...
\begin{frame}[label=full,fragile]{Easy Pandas -- Create New Columns}
...
\begin{frame}[label=full,fragile]{Easy Pandas -- Renaming Columns}
...
\begin{frame}[label=full,fragile]{Easy Pandas -- Distinct Values}
\begin{pythoncode}
...
\begin{frame}[label=full,fragile]{Easy Pandas -- Ordering}
\begin{pythoncode}
...
\begin{frame}[label=full,fragile]{Easy Pandas -- Grouping and Summarizing}
\begin{pythoncode}
...
\end{frame}
\begin{frame}[label=full,fragile]{Grouping and Summarizing \small [cont'd]}
\begin{columns}
\begin{column}{.5\textwidth}
Equivalent in R:
\begin{Rcode}
...
\begin{frame}[label=full,fragile]{Advanced Pandas with the Pagila Database}
\begin{pythoncode}
rentals = pd.read_csv(
...
\begin{frame}[label=full,fragile]{Advanced Pandas with the Pagila Database  \small [cont'd]}
