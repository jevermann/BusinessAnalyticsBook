...
\url{https://www.youtube.com/watch?v=m5-tgawhBUU}
\end{videobox}
\end{advanced}
...
%\begin{infobox}To read and execute Python statements from a file, use the expression \texttt{exec(open('filename.py').read())}
%\end{infobox}
