...
\url{https://www.youtube.com/watch?v=h2LMvBZFEhM}
\end{videobox}
\end{advanced}
...
\begin{exerciseboxpaper}
Define a graph in Cypher that represents the following relational data: \\ 
...
\footnotesize
\begin{minted}[autogobble,label=Python,numbers=left,bgcolor=code,breakbytoken,python3,frame=single]{python}
