...
\begin{frame}[label=full]{Use Cases}
\begin{itemize}
...
\begin{frame}[label=full]{Graph Query Languages}
...
\begin{frame}[label=withcode]{Graph Analytics with Neo4J and Cypher}
\begin{itemize}
...
\begin{frame}[label=full]{Neo4J Property Graphs}
...
\begin{frame}[label=full]{The Cypher Language}
...
\begin{frame}[label=full,fragile]{Cyper and Graph Concepts}
\centering
...
\begin{frame}[label=full]{Cypher and Graph Concepts}
\centering
...
\begin{frame}[label=full,fragile]{Cypher Syntax}
...
\begin{frame}[label=full,fragile]{Cypher Syntax \small [cont'd]}
\small
...
\begin{frame}[label=full]{Defining Graphs in Cypher}
\centering
...
\begin{frame}[label=full,fragile]{Defining Graphs in Cypher}
...
\begin{quote}
Jane has purchased a Corolla vehicle with VIN (vehicle identification number) 101010. The Corolla is manufactured by Toyota in Cambridge, ON. The vehicle was sold to Jane by the dealer ''St. John's Toyota'' for a price of \$35,000.00.
\end{quote}
...
\begin{frame}[label=full,fragile]{Clean-Up}
...
\begin{frame}[label=full,fragile]{Property or Relationship?}
\begin{columns}
...
\begin{frame}[label=full]{Flexible Data Modeling}
\centering
...
\begin{frame}[label=full]{Graph Data versus Relational Data}
\centering
...
\begin{column}{0.8\textwidth}
\footnotesize
Define a graph in Cypher that represents the following relational data: \\ \vspace{\baselineskip}
...
\multicolumn{2}{c}{\bf Customer} \\ \hline
{\bf CNumber} & {\bf Name} \\ \hline
1 & Jane \\
2 & John \\ \hline
\end{tabular}
\smallskip
\begin{tabular}{l|l} \hline
\multicolumn{2}{c}{\bf Product} \\ \hline
{\bf PNumber} & {\bf Name} \\ \hline
10 & Hammer \\
11 & Saw \\ \hline
\end{tabular}
\smallskip
\begin{tabular}{l|l|l} \hline
\multicolumn{3}{c}{\bf Sales} \\ \hline
{\bf CNumber} & {\bf PNumber} & {\bf Price} \\ \hline
1 & 11 & \$10 \\ 
2 & 10 & \$12 \\
2 & 11 & \$10 \\ \hline
\end{tabular}
...
\begin{frame}[label=withcode,fragile]{The Pagila Database for Neo4J}
...
\begin{frame}[label=withcode]{Explore the Pagila Graph}
\centering

\includegraphics[height=3in]{screen12.png}
\end{frame}

\begin{frame}[label=withcode,fragile]{Explore the Pagila Schema}
\small
\begin{cyphercode}
...
\begin{frame}[label=withcode,fragile]{Cypher Query Examples}
...
\begin{frame}[label=withcode,fragile]{Cypher Query Examples \small [cont'd]}
...
\begin{frame}[label=withcode]{Further Information}
