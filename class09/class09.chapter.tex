...
\begin{exercisebox}
Draw an annotated DFG for the following an event log showing the \emph{mean} time between activities: \\ \vspace{\baselineskip}
...
\begin{exercisebox}
Draw a dotted chart for the following an event log. Use different colours or different symbols for the different activities. \\ \vspace{\baselineskip}
...
\begin{exercisebox}
Draw a handover-of-work graph for the following an event log showing the \emph{mean} time between activities: \\ \vspace{\baselineskip}
