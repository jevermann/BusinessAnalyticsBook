...
\begin{frame}[label=advanced]{Multi-Class Classification Model Quality}
\begin{block}{}
\small
\begin{center}
\renewcommand{\arraystretch}{1.25}
...
\begin{frame}[label=advanced]{Multi-Class Classification Model Quality \small [cont'd]}
...
\begin{frame}[label=advanced]{Hands-On Exercises -- Cross-Entropy \& KL Divergence}
\begin{columns}
\begin{column}{0.2\textwidth}
\href{https://commons.wikimedia.org/wiki/File:Emojione_BW_1F44B.svg}{\includegraphics[width=\textwidth]{hand.png}}
\end{column}
...
\begin{frame}[label=advanced]{Hands-On Exercises -- Cross-Entropy}
\begin{columns}
\begin{column}{0.2\textwidth}
\href{https://commons.wikimedia.org/wiki/File:Emojione_BW_1F44B.svg}{\includegraphics[width=\textwidth]{hand.png}}
\end{column}
...
\begin{frame}[label=advanced]{Hands-On Exercise -- Cross-Entropy in Binary Classification}
\begin{columns}
\begin{column}{0.2\textwidth}
\href{https://commons.wikimedia.org/wiki/File:Emojione_BW_1F44B.svg}{\includegraphics[width=\textwidth]{hand.png}}
\end{column}
...
\begin{frame}[label=advanced]{Hands-On Exercise -- KL Divergence in Practice}
\begin{columns}
\begin{column}{0.2\textwidth}
\href{https://commons.wikimedia.org/wiki/File:Emojione_BW_1F44B.svg}{\includegraphics[width=\textwidth]{hand.png}}
\end{column}
...
\begin{frame}[label=advanced]{Review Questions -- Cross-Entroy \& KL Divergence}
\begin{enumerate}
