...
\begin{frame}[label=full]{Supervised Learning}
\begin{itemize}
...
\begin{frame}[label=full]{Regression}
  \begin{itemize}
...
\begin{frame}[label=full]{Regression Methods -- Examples}
...
\begin{frame}[label=full]{Classification Methods -- Examples}
\begin{itemize}
   \item Decision trees
   \item Random forests
...
\begin{frame}[label=full]{Prediction and Explanation}
...
\begin{frame}[label=full]{Prediction and Explanation \small [cont'd]}
\begin{center}
...
\begin{frame}[label=full]{Model Quality --- Regression}
...
\begin{align*}
MAE = \frac{1}{n}\sum_{i=1}^n |y_i - \hat{f}(x_i)| \qquad \qquad
\end{align*}
\end{itemize}
\end{frame}
...
\begin{frame}[label=full]{Quality of Fit}{Between model and data}
...
\begin{frame}[label=full]{Quality of Fit \small [cont'd]}
...
\begin{frame}[label=full]{Overfitting with Polynomial Expansions}
\centering
...
\begin{frame}[label=advanced]{Bias and Variance}
...
\begin{frame}[label=advanced]{Bias and Variance Decomposition \\ \small Example using mean squared error loss}
\begin{align*}
...
\begin{frame}[label=advanced]{Bias and Variance Decomposition \small [cont'd] \\ \small Example using mean squared error loss}
\begin{align*}
...
\begin{frame}[label=full]{Bias and Variance Trade-Off}
\centering
...
\begin{frame}[label=full]{Bias and Variance Trade-Off \small [cont'd]}
...
%\begin{frame}[label=full]{Model Bias and Estimation Bias in Penalized Models}{Examples: Ridge Regression or LASSO}
%\begin{columns}
...
%\begin{frame}[label=full]{Review Questions -- Bias and Variance}
%\begin{enumerate}
...
%\begin{frame}[label=full]{Review Questions -- Bias and Variance \small [cont'd]}
%\begin{enumerate}
  %\setcounter{enumi}{4}
...
\begin{frame}[label=full]{Model Quality --- Classification}
...
\begin{frame}[label=full]{Bayes Classifier}
\small
...
\begin{frame}[label=full]{Bayes Decision Boundary}
...
\begin{frame}[label=full]{Bayes Classifier \small [cont'd]}
\begin{itemize}
...
\begin{frame}[label=full]{Example --- K-Nearest-Neighbour (KNN)}
\begin{itemize}
...
\begin{frame}[label=full]{KNN and Bayes Classifier}
\centering
...
\begin{frame}[label=full]{KNN Quality}
\centering
...
\begin{frame}[label=full]{KNN Error Rates}
\centering
...
\begin{frame}[label=full]{Hands-On Exercise -- KNN}
\begin{columns}
\begin{column}{0.2\textwidth}
...
\begin{frame}[label=full]{Binary Classification Quality --- Confusion Matrix}
...
\begin{frame}[label=full]{Confusion Matrix -- Adjusting Thresholds \small [cont'd]}
\begin{block}{}
\begin{center}
\renewcommand{\arraystretch}{1.25}
...
\begin{frame}[label=full]{Confusion Matrix \small [cont'd]}
\begin{block}{}
\small
\begin{center}
\renewcommand{\arraystretch}{1.25}
...
\begin{frame}[label=full]{Binary Classification Model Quality}
\begin{itemize}
...
\begin{frame}[label=full]{Binary Classification Model Quality \small [cont'd]}
\begin{itemize}
...
\begin{frame}[label=full]{Hands-On Exercise -- Basic Calculations}
\begin{columns}
\begin{column}{0.2\textwidth}
\href{https://commons.wikimedia.org/wiki/File:Paper_and_pencil_Pinhead_icon.svg}{\includegraphics[width=.75\textwidth]{../pencilblack.png}}
\end{column}
...
\begin{frame}[label=full]{Hands-On Exercise -- Real World Scenario}
\begin{columns}
\begin{column}{0.2\textwidth}
\href{https://commons.wikimedia.org/wiki/File:Paper_and_pencil_Pinhead_icon.svg}{\includegraphics[width=.75\textwidth]{../pencilblack.png}}
\end{column}
\begin{column}{0.8\textwidth}
Consider a medical test where 1000 individuals are tested for a disease:
\begin{itemize}
  \item 100 people actually have the disease, 900 do not.
...
\begin{frame}[label=full]{Hands-On Exercise -- Interpretation Challenge}
\begin{columns}
\begin{column}{0.2\textwidth}
\href{https://commons.wikimedia.org/wiki/File:Paper_and_pencil_Pinhead_icon.svg}{\includegraphics[width=.75\textwidth]{../pencilblack.png}}
\end{column}
...
\begin{frame}[label=full]{Hands-On Exercise -- Adjusting Thresholds}
\begin{columns}
\begin{column}{0.2\textwidth}
\href{https://commons.wikimedia.org/wiki/File:Paper_and_pencil_Pinhead_icon.svg}{\includegraphics[width=.75\textwidth]{../pencilblack.png}}
\end{column}
...
\end{itemize}
\vspace{\baselineskip}
\emph{Describe how adjusting the classification threshold might affect precision, recall, and accuracy. What happens if the threshold is increased or decreased?}
\end{column}
\end{columns}
\end{frame}

%\begin{frame}[label=full]{Hands-On Exercise -- Base Rate Fallacy, Unbalanced Data}
...
\begin{frame}[label=full]{Multi-Class Classification Model Quality}
\begin{block}{}
\small
\begin{center}
\renewcommand{\arraystretch}{1.25}
...
\begin{frame}[label=full]{Multi-Class Classification Model Quality \small [cont'd]}
...
\begin{frame}[label=full]{Hands-On Exercises -- Cross-Entropy \& KL Divergence}
\begin{columns}
\begin{column}{0.2\textwidth}
\href{https://commons.wikimedia.org/wiki/File:Paper_and_pencil_Pinhead_icon.svg}{\includegraphics[width=.75\textwidth]{../pencilblack.png}}
\end{column}
...
\begin{frame}[label=full]{Hands-On Exercises -- Cross-Entropy}
\begin{columns}
\begin{column}{0.2\textwidth}
\href{https://commons.wikimedia.org/wiki/File:Paper_and_pencil_Pinhead_icon.svg}{\includegraphics[width=.75\textwidth]{../pencilblack.png}}
\end{column}
...
\begin{frame}[label=full]{Hands-On Exercise -- Cross-Entropy in Binary Classification}
\begin{columns}
\begin{column}{0.2\textwidth}
\href{https://commons.wikimedia.org/wiki/File:Paper_and_pencil_Pinhead_icon.svg}{\includegraphics[width=.75\textwidth]{../pencilblack.png}}
\end{column}
...
\begin{frame}[label=full]{Hands-On Exercise -- KL Divergence in Practice}
\begin{columns}
\begin{column}{0.2\textwidth}
\href{https://commons.wikimedia.org/wiki/File:Paper_and_pencil_Pinhead_icon.svg}{\includegraphics[width=.75\textwidth]{../pencilblack.png}}
\end{column}
...
\begin{frame}[label=full]{Review Questions -- Cross-Entroy \& KL Divergence}
\begin{enumerate}
...
\begin{frame}[label=full]{Resampling Methods}
\begin{block}{Goals}
\begin{itemize}
...
\begin{frame}[label=full]{Validation Set Approach (''Holdout'' Method)}
...
\begin{frame}[label=full]{Leave One Out Cross-Validation (LOOCV)}
\begin{block}{Procedure}
\begin{enumerate}
...
\begin{frame}[label=full]{k-Fold Cross-Validation}
\begin{block}{Procedure}
\begin{enumerate}
...
\begin{frame}[label=full]{Cross-Validation}
...
\begin{frame}[label=full]{Hands-On Exercise -- Crossvalidation Methods}
\begin{columns}
\begin{column}{0.2\textwidth}
\href{https://commons.wikimedia.org/wiki/File:Paper_and_pencil_Pinhead_icon.svg}{\includegraphics[width=.75\textwidth]{../pencilblack.png}}
\end{column}
\begin{column}{0.8\textwidth}
Assume you have a dataset with 1000 observations and you wish to develop a predictive model using linear regression. \\

\vspace{\baselineskip}
For each of the following cross-validation methods, describe the number of linear regression models you fit, the size of each training set, and the size of the validation set.
