...
\begin{frame}[label=full]{Intro to R}
...
\begin{frame}[label=full]{R}
\centering
\includegraphics[width=\textwidth]{screen1.png}
\end{frame}

\begin{frame}[label=full]{Tips for Working with R}
...
\begin{frame}[label=full,fragile]{My First R Commands}
R can do math:
\begin{Rcode}
> 1+1
[1] 2
...
\begin{frame}[label=full,fragile]{R Basics}
...
\begin{frame}[label=full,fragile]{R Basics \small [cont'd]}
...
\begin{frame}[label=full,fragile]{R Environment}
...
\begin{frame}[label=full,fragile]{R Environment \small [cont'd]}
R can help:
\begin{Rcode}
help()
help(lm)
...
\begin{frame}[label=full,fragile]{R Vectors}
...
\begin{frame}[label=full,fragile]{R Vectors \small [cont'd]}
...
\begin{frame}[label=full,fragile]{R Missing Values}
R knows NA:
\begin{Rcode}
...
\begin{frame}[label=full,fragile]{R Arrays and Matrices}
...
\begin{frame}[label=full]{R Arrays and Matrices \small [cont'd]}
\begin{itemize}
...
\begin{frame}[label=full,fragile]{R Arrays and Matrices \small [cont'd]}
\begin{Rcode}
...
%\begin{frame}[label=full,fragile]{R Lists}
%R knows lists:
%\begin{Rcode}
%l <- list('a', 3, 'b', 2, TRUE)
%l[[2]]
...
\begin{frame}[label=full,fragile]{R Data Frames}
\begin{Rcode}
...
\begin{frame}[label=full,fragile]{Data Frames \small [cont'd]}
Writing data to CSV:
\begin{Rcode}
...
\begin{frame}[label=full]{Tidyverse}
...
\begin{frame}[label=full]{Tidyverse Packages}
...
\begin{frame}[label=full]{Example Dataset}
\begin{itemize}
...
\begin{frame}[label=full,fragile]{Read Data}
...
\begin{frame}[label=full]{Summary of DPlyr ''Verbs''}
...
\begin{frame}[label=full,fragile]{Filter()}
...
\begin{frame}[label=full,fragile]{Select()}
...
\begin{frame}[label=full,fragile]{Mutate()}
...
\begin{frame}[label=full,fragile]{Rename()}
...
\begin{frame}[label=full,fragile]{Distinct()}
...
\begin{frame}[label=full,fragile]{Arrange()}
...
\begin{frame}[label=full,fragile]{Relocate()}
...
\begin{frame}[label=full,fragile]{Group\_by() and summarize()}
...
\begin{frame}[label=full,fragile]{Pagila Database in R}
...
\begin{frame}[label=full,fragile]{Pagila Database in R \small [cont'd]}
Examine the NA's:
\footnotesize
\begin{Rcode}
rentals |> 
...
\begin{frame}[label=full,fragile]{R knows SQL}
...
\begin{frame}[label=full]{SQL Databases versus R/Tidyverse}
...
\begin{frame}[label=full]{SQL Databases versus R/Tidyverse \small [cont'd]}
