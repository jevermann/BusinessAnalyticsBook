...
\begin{frame}[label=full]{Resources}
...
\begin{frame}[label=full]{Biological Neuron}
\begin{itemize}
  \item Brain cell
...
\begin{frame}[label=full]{Artificial Neuron}
\begin{align*}
...
%\begin{frame}[label=full]{Popular Activation Functions}
%\footnotesize
%\centering
...
\begin{frame}[label=full]{Fully Connected Hidden Layer}
\centering
...
\begin{frame}[label=full]{Counting Parameters}
...
\begin{frame}[label=full]{Fully Connected Multilayer Network}
\begin{columns}
...
Calculate the total number of trainable parameters for this network.
\end{column}
\end{columns}
\end{frame}


\begin{frame}[label=full]{Estimating Parameters}
\footnotesize
...
\begin{frame}[label=full]{Gradient Descent}
\begin{enumerate}
...
\begin{frame}[label=full]{Hands-On Exercise --- Gradient Descent}
\begin{columns}
\begin{column}{0.2\textwidth}
\href{https://commons.wikimedia.org/wiki/File:Paper_and_pencil_Pinhead_icon.svg}{\includegraphics[width=.75\textwidth]{../pencilblack.png}}
\end{column}
\begin{column}{0.8\textwidth}
\small
Assume optimizing your neural network for a single parameter $\theta$ and your loss function is of the form $\theta^2$ (that means your gradient function is of the form $2\theta$). 
\begin{enumerate}
   \item Sketch your loss function and its gradient against $\theta$
   \item What is the optimal (minimal) loss?
   \item Starting at $\theta=2$ Using $\lambda = 0.25$, calculate successive values for $\theta$. How many steps do you require to reach the optimal loss? What criterion have you used to stop?
   \item Starting at $\theta=2$ Using $\lambda = 0.1$, calculate successive values for $\theta$. How many steps do you require to reach the optimal loss? What criterion have you used to stop?
\end{enumerate}
\emph{Note:} For this illustration exercise, assume that $\theta$ and its gradient are independent of data values $x$.
\end{column}
\end{columns}
\end{frame}


\begin{frame}[label=full]{Optimization Problems}
\begin{itemize}
...
\begin{frame}[label=full]{Optimization Options}
...
\begin{frame}[label=full]{Training Neural Networks -- Epochs and Minibatches}
\begin{itemize}
...
\begin{frame}[label=full]{Optimization Options -- Stochastic Gradient Descent}
\begin{itemize}
...
\begin{frame}[label=full]{Hands-On Exercise --- Adaptive Learning Rates}
\begin{columns}
\begin{column}{0.2\textwidth}
\href{https://commons.wikimedia.org/wiki/File:Paper_and_pencil_Pinhead_icon.svg}{\includegraphics[width=.75\textwidth]{../pencilblack.png}}
\end{column}
...
Assume optimizing your neural network for a single parameter $\theta$ and your loss function is of the form $\theta^2$ (that means your gradient function is of the form $2\theta$). 
\begin{enumerate}
   \item Starting at $\theta=2$ Using $\lambda = 0.25$, calculate successive values for $\theta$. Reduce $\lambda$ by half at every step. 
   \item How many steps do you require to reach the optimal loss? What criterion have you used to stop?
\end{enumerate}
\emph{Note:} For this illustration exercise, assume that $\theta$ and its gradient are independent of data values $x$.
\end{column}
\end{columns}
...
\begin{frame}[label=full]{Optimization Options -- AdaGrad}{Adaptive Gradient}
\begin{itemize}
...
\begin{frame}[label=full]{Hands-On Exercise --- AdaGrad}
\begin{columns}
\begin{column}{0.2\textwidth}
\href{https://commons.wikimedia.org/wiki/File:Paper_and_pencil_Pinhead_icon.svg}{\includegraphics[width=.75\textwidth]{../pencilblack.png}}
\end{column}
...
Assume optimizing your neural network for a single parameter $\theta$ and your loss function is of the form $\theta^2$ (that means your gradient function is of the form $2\theta$). 
\begin{enumerate}
   \item Starting at $\theta=2$ Using a constant $\lambda = 0.1$ and $\epsilon=0.1$, calculate successive values for $\theta$ and $s$. 
   \item How many steps do you require to reach the optimal loss? What criterion have you used to stop?
\end{enumerate}
\emph{Note:} For this illustration exercise, assume that $\theta$ and its gradient are independent of data values $x$.
\end{column}
...
\begin{frame}[label=full]{Optimization Options -- RMSProp}
\begin{itemize}
...
\begin{frame}[label=full]{Hands-On Exercise --- RMSProp}
\begin{columns}
\begin{column}{0.2\textwidth}
\href{https://commons.wikimedia.org/wiki/File:Paper_and_pencil_Pinhead_icon.svg}{\includegraphics[width=.75\textwidth]{../pencilblack.png}}
\end{column}
\begin{column}{0.8\textwidth}
\small
Assume optimizing your neural network for a single parameter $x$ and your loss function is of the form $x^2$ (that means your gradient function is of the form $2x$). 
\begin{enumerate}
   \item Starting at $x=2$ Using a constant $\lambda = 0.1$ and $\beta=0.75, \epsilon=0.1$, calculate successive values for $x$ and $s$. 
   \item How many steps do you require to reach the optimal loss? What criterion have you used to stop?
\end{enumerate}
\emph{Note:} For this illustration exercise, assume that $\theta$ and its gradient are independent of data values $x$.
\end{column}
...
\begin{frame}[label=full]{Optimization Options -- AdaDelta}
\begin{itemize}
...
\begin{frame}[label=full]{Optimization Options -- Momentum Methods}
\begin{itemize}
...
\begin{frame}[label=full]{Optimization Options -- AdaM}{Adaptive Moment Estimation}
\begin{itemize}
...
\begin{frame}[label=full]{Hands-On Exercise --- AdaM}
\begin{columns}
\begin{column}{0.2\textwidth}
\href{https://commons.wikimedia.org/wiki/File:Paper_and_pencil_Pinhead_icon.svg}{\includegraphics[width=.75\textwidth]{../pencilblack.png}}
\end{column}
...
Assume optimizing your neural network for a single parameter $x$ and your loss function is of the form $x^2$ (that means your gradient function is of the form $2x$). 
\begin{enumerate}
   \item Starting at $x=2$ Using a constant $\lambda = 0.1$ and $\beta_1=0.5, \beta_2=0.5, \epsilon=0.1$, calculate successive values for $x$ and $s$ and $m$. 
   \item How many steps do you require to reach the optimal loss? What criterion have you used to stop?
\end{enumerate}
...
\begin{frame}[label=full]{Training Neural Networks -- Vanishing Gradients }
\begin{block}{Problem}
\begin{itemize}
...
\begin{frame}[label=full]{Training Neural Networks -- ResNet Architecture}
\begin{itemize}
...
\begin{frame}[label=full]{Training Neural Networks -- Exploding Gradients }
\begin{block}{Problem}
\begin{itemize}
...
\begin{frame}[label=full]{Training Neural Networks -- Parameter Initialization Heuristics}
\begin{itemize}
...
\begin{frame}[label=full]{Regularization -- Dropout}
\begin{itemize}
...
\begin{frame}[label=withcode]{Tensorflow}
\begin{columns}
...
\begin{frame}[label=withcode]{Keras}
\begin{columns}
\begin{column}{0.3\textwidth}
...
\begin{frame}[label=withcode,fragile]{Regression using Keras}
...
\begin{frame}[label=withcode,fragile]{Regression using Keras \small [cont'd]}
...
\begin{frame}[label=withcode,fragile]{Regression in Keras \small [cont'd]}
...
\begin{frame}[label=withcode,fragile]{Classification in Keras}
...
\begin{frame}[label=withcode,fragile]{Classification in Keras \small [cont'd]}
...
\begin{frame}[label=withcode]{TensorBoard}
...
\begin{frame}[label=withcode,fragile]{Early Stopping}
